...
- History batch client-secret-not-configured envelope RED: targeted test failed with legacy-only `{"error": "client_secret_not_configured"}`
- Targeted history batch client-secret-not-configured envelope test: `1 passed`
- Affected history/http tests: `110 passed`
- Full suite: `622 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
