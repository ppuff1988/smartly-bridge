...
- History batch no-allowed-entities envelope RED: targeted test failed with legacy-only `{"error": "no_allowed_entities"}`
- Targeted history batch no-allowed-entities envelope test: `1 passed`
- Affected history/http tests: `116 passed`
- Full suite: `628 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
