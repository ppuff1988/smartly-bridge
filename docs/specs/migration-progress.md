...
- History single-query rate-limit envelope RED: targeted test failed with legacy-only `{"error": "rate_limited"}`
- Targeted history single-query rate-limit envelope test: `1 passed`
