...
- History batch too-many-entities envelope RED: targeted test failed with legacy-only `{"error": "too_many_entities", "max_entities": 50}`
- Targeted history batch too-many-entities envelope test: `1 passed`
- Affected history/http tests: `115 passed`
- Full suite: `627 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
