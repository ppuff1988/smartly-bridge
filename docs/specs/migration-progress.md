...
- History batch rate-limit envelope RED: targeted test failed with legacy-only `{"error": "rate_limited"}`
- Targeted history batch rate-limit envelope test: `1 passed`
- Affected history/http tests: `112 passed`
- Full suite: `624 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
