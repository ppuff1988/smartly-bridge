...
- History statistics entity-not-allowed envelope RED: targeted test failed with legacy-only `{"error": "entity_not_allowed"}`
- Targeted history statistics entity-not-allowed envelope test: `1 passed`
- Affected history/http tests: `105 passed`
- Full suite: `617 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
