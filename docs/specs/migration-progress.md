...
- History single-query entity-not-allowed envelope RED: targeted test failed with legacy-only `{"error": "entity_not_allowed"}`
- Targeted history single-query entity-not-allowed envelope test: `1 passed`
