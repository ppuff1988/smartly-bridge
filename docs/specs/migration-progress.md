...
- History batch authentication failure envelope RED: targeted test failed with legacy-only `{"error": "invalid_signature"}`
- Targeted history batch authentication failure envelope test: `1 passed`
- Affected history/http tests: `111 passed`
- Full suite: `623 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
