...
- Legacy control missing required fields envelope RED: targeted test failed with legacy-only `{"error": "missing_required_fields"}`
- Targeted legacy control missing required fields envelope test: `1 passed`
