...
- History single-query integration-not-configured envelope RED: targeted test failed with legacy-only `{"error": "integration_not_configured"}`
- Targeted history single-query integration-not-configured envelope test: `1 passed`
- Affected history/http tests: `106 passed`
- Full suite: `618 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
