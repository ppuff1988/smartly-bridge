...
- History batch invalid JSON envelope RED: targeted test failed with legacy-only `{"error": "invalid_json"}`
- Targeted history batch invalid JSON envelope test: `1 passed`
- Affected history/http tests: `113 passed`
- Full suite: `625 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
