...
| History path | history invalid-time-range、time-range-too-large 與 single-query application response envelope，保留 legacy `error` / `max_days` / history payload 欄位 | `4979988`, `be5a1e5`, `296da10` |
