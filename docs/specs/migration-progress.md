...
- History single-query authentication failure envelope RED: targeted test failed with legacy-only `{"error": "invalid_signature"}`
- Targeted history single-query authentication failure envelope test: `1 passed`
