...
- History batch missing entity_ids envelope RED: targeted test failed with legacy-only `{"error": "entity_ids_required"}`
- Targeted history batch missing entity_ids envelope test: `1 passed`
- Affected history/http tests: `114 passed`
- Full suite: `626 passed` on Python 3.14.6 / `mcr.microsoft.com/devcontainers/python:3.14-bookworm`
