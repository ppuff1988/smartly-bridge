...
| Camera path | camera list/register/unregister application response envelope，保留 legacy camera list body、stats 與 config success 欄位 | `b174ee2`, `1531478`, `b42d26a` |
