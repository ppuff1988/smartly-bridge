...
| Camera path | camera list/register/unregister/clear-cache/config-list application response envelope，保留 legacy camera list body、stats 與 config success/list 欄位 | `b174ee2`, `1531478`, `b42d26a`, `7660fb8`, `9ef6f75` |
