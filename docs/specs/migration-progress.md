...
- History single-query missing entity_id envelope RED: targeted test failed with legacy-only `{"error": "entity_id_required"}`
- Targeted history single-query missing entity_id envelope test: `1 passed`
